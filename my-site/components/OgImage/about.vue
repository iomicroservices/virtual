...
<template>
  <div class="w-full h-full flex flex-col justify-center bg-[#020420]">
    ...
    <div class="container" style="max-width: 600px; padding-left: 100px">
      <p v-if="headline" class="text-uppercase text-success mb-4 fw-semibold" style="font-size: 24px;">
        {{ headline }}
      </p>

      <h1 class="m-0 mb-4 fw-semibold text-white d-flex align-items-center" style="font-size: 75px;">
        <span>{{ title }}</span>
      </h1>

      <p class="mb-4" style="font-size: 32px; color: #E4E4E7; line-height: 1.25;">
