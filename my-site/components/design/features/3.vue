...
<div class="container pb-6 position-relative">
    ...
    <div class="row">
        <!-- Tabs -->
        <div class="col-lg-10 col-xl-8 col-xxl-6 mx-auto mb-6 mb-xl-8">
            <div class="bg-light rounded-pill p-2">
                <ul class="nav nav-pills nav-pills-primary nav-responsive justify-content-between" role="tablist">
                    ...
                    <li class="nav-item position-relative" role="presentation">
                        <!-- Badge -->
                        <span class="badge text-bg-danger position-absolute top-0 start-100 translate-middle mt-n2 ms-n5 d-none d-lg-block">Coming soon</span>
                        <button class="nav-link rounded-pill" id="pills-automation-tab" aria-selected="false" tabindex="-1" role="tab"><i class="bi bi-gear me-2"></i>Automation</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link rounded-pill" id="pills-scalability-tab" aria-selected="false" tabindex="-1" role="tab"><i class="bi bi-pie-chart me-2"></i>Scalability</button>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="tab-pane fade show active" id="pills-analytics" role="tabpanel" aria-labelledby="pills-analytics-tab" tabindex="0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 mb-6 mb-lg-0">
                            ...
                            <h3 class="my-4">Comprehensive data analytics and reporting</h3>
                        ...
                        <div class="col-lg-4 position-relative ms-auto">
                            <!-- SVG decoration -->
                            ...
                            <!-- Image -->
                            <img src="assets/images/about/14.jpg" class="rounded position-relative zindex-2" alt="feature-img">

                            <!-- Decoration -->
                            <div class="bg-white rounded d-flex align-items-center position-absolute top-0 end-0 mt-n5 px-3 py-2">
                                <p class="text-dark fw-bold mb-0">Meeting with</p>
                                <!-- Avatar -->
                            ...
                            <!-- Decoration -->
                            <div class="card card-body position-absolute bottom-0 start-0 ms-lg-n8 mb-n5">
                                ...
                                <div class="overflow-hidden">
                                    ...
                                    <div class="progress progress-sm bg-primary bg-opacity-10">
                                        <div class="progress-bar bg-primary aos aos-init aos-animate" role="progressbar" data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 80%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="pills-collaboration" role="tabpanel" aria-labelledby="pills-collaboration-tab" tabindex="0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 mb-6 mb-lg-0">
                            ...
                            <h3 class="my-4">Streamlined teamwork and client engagement</h3>
                            <p class="mb-5">Our collaboration feature empowers your agency with seamless teamwork and enhanced client engagement.</p>
                            <!-- Feature -->
                        ...
                        <div class="col-lg-4 position-relative ms-auto">
                            <!-- Decoration -->
                            <div class="col-md-8 position-absolute top-50 start-0 translate-middle mt-xl-n9 d-none d-lg-block">
                            ...
                            <div class="d-inline-block bg-white shadow rounded-4 position-absolute end-0 bottom-0 p-3 mb-n5 me-lg-n6 d-none d-sm-block">
                                <img src="assets/images/elements/trustpilot.svg" class="h-20px mb-2" alt="Client-img">
                                <div class="d-flex align-items-center">
                            ...
                            <!-- Image -->
                            <img src="assets/images/about/17.jpg" class="rounded" alt="feature-img">		
                        </div>
                    </div>
                </div>
            </div>
