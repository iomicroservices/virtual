			...
			<div class="col-xl-4">
				<div class="card card-body d-flex p-4 border h-100 flex-md-row flex-xl-column">
					...
					<div class="mt-auto p-0">
						<img src="assets/images/elements/integration.png" alt="feature-img">
					</div>
				</div>
			</div>
							...
							<div class="row g-4">
								...
								<div class="col-md-6">
									...
									<div class="me-n9 mb-n6">
										<img src="assets/images/elements/saas-feature.png" class="card-img border border-dark border-5" alt="feature-img">
									</div>
								</div>
							</div>
						</div>
