            ...
            <div class="bg-light rounded-pill p-2">
                <ul class="nav nav-pills nav-pills-primary nav-responsive justify-content-between">
                    ...
                    <li class="nav-item position-relative" role="presentation">
                        ...
                        <button class="nav-link rounded-pill" id="pills-automation-tab"><i class="bi bi-gear me-2"></i>Automation</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link rounded-pill" id="pills-scalability-tab"><i class="bi bi-pie-chart me-2"></i>Scalability</button>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="card card-body position-absolute bottom-0 start-0 ms-lg-n8 mb-n5">
                                ...
                                <div class="overflow-hidden">
                                    ...
                                    <div class="progress progress-sm bg-primary bg-opacity-10">
                                        <div class="progress-bar bg-primary aos" role="progressbar" data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 80%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            </div>
