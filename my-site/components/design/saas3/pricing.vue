...
<section class="pb-0">
	<div class="container">
		<div class="row g-4 g-sm-6 g-xl-7">
			<!-- Download box -->
			<div class="col-lg-6">
				<div class="card bg-light overflow-hidden p-0 h-100">
					<!-- Pattern -->
					...
					<!-- Card body -->
					<div class="card-body position-relative p-sm-6 pb-lg-0">
						<h2 class="mb-4">Anywhere, Any Time, Any Platform</h2>
						<p class="heading-color mb-4">Download the app for free and get access to accurate plant diagnoses with no extra charges.</p>
						<!-- Download button -->
						<div class="row g-2">
					...
					<div class="card-footer bg-transparent p-0">
						<img src="assets/images/elements/saas-screen.png" class="ms-5" alt="">
					</div>
				</div>
			</div>
			...
			<!-- Pricing -->
			<div class="col-lg-6">
				<div class="card bg-dark overflow-hidden p-sm-4 h-100" data-bs-theme="dark">
					<!-- Pattern -->
					<div class="position-absolute end-0 bottom-0 mb-n3 me-n3">
						<img src="assets/images/elements/pattern.svg" class="opacity-1" alt="">
					</div>

					<!-- Card header -->
					<div class="card-header text-center bg-transparent position-relative">
						<!-- Logo -->
						<img src="assets/images/logo-icon.svg" class="mb-4" alt="logo-icon">
						<h3 class="mb-2">Affordable pricing pack</h3>
						<p>Our essential plan is self-service solution for businesses to handle website messaging and personalization</p>
					</div>

					<!-- Card body -->
					<div class="card-body bg-light border rounded mx-2 mx-sm-4 position-relative">
						<h6 class="mb-3">Quick look at all the features</h6>
						<!-- List -->
						<ul class="list-group list-group-borderless">
							<li class="list-group-item mb-0"><i class="bi bi-patch-check-fill text-primary me-2"></i>Unlimited monthly visitors</li>
							<li class="list-group-item mb-0"><i class="bi bi-patch-check-fill text-primary me-2"></i>Dedicated SEO strategists</li>
							<li class="list-group-item mb-0"><i class="bi bi-patch-check-fill text-primary me-2"></i>Google Docs style editors</li>
							<li class="list-group-item mb-0"><i class="bi bi-patch-check-fill text-primary me-2"></i>Basic chat and email support</li>
							<li class="list-group-item mb-0"><i class="bi bi-patch-check-fill text-primary me-2"></i>AI powered product recommendation engine</li>
						</ul>
					</div>

					<!-- Card footer -->
					<div class="card-footer text-center bg-transparent position-relative mt-3">
						<!-- Price -->
						<div class="mb-4 heading-color"><span class="h2">$299</span> /month</div>
						<!-- Button -->
						<a href="#" class="btn btn-lg btn-primary w-100 mb-0">Get 1 year access</a>
					</div>
				</div>
			</div>
		</div>
