	...
	<div class="container position-relative">
		<div class="bg-dark rounded position-relative overflow-hidden p-4 p-sm-7">
			...
			<figure class="position-absolute top-0 start-0 mt-n5">
				<svg class="fill-light" style="opacity:0.02" width="662" height="614" viewBox="0 0 662 614" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="row g-4 position-relative">
				...
				<div class="col-lg-10 col-xl-7 mx-auto text-center">
					<!-- Title -->
					<h3 class="text-white mb-3">Bring your productivity to next level</h3>
					<p class="text-white opacity-8">The bore of true of no be deal. Drawings offended yet answered Jennings perceive laughing six did far. Points afraid but may end law lasted.</p>
					<a href="#" class="btn btn-primary mb-md-5">Join our waitlist</a>
					...
					<div class="swiper" data-swiper-options='{
						...
						<div class="swiper-wrapper align-items-center">
							...
							<div class="swiper-slide">
								<img src="assets/images/client/05.svg" class="grayscale px-sm-3 ps-0" alt="client-img">
							</div>
							<!-- Image -->
							<div class="swiper-slide">
								<img src="assets/images/client/01.svg" class="grayscale px-sm-3" alt="client-img">
							</div>
							<!-- Image -->
							<div class="swiper-slide">
								<img src="assets/images/client/02.svg" class="grayscale px-sm-3" alt="client-img">
							</div>
							<!-- Image -->
							<div class="swiper-slide">
								<img src="assets/images/client/03.svg" class="grayscale px-sm-3" alt="client-img">
							</div>
							<!-- Image -->
							<div class="swiper-slide">
								<img src="assets/images/client/04.svg" class="grayscale px-sm-3" alt="client-img">
							</div>
							<!-- Image -->
							<div class="swiper-slide">
								<img src="assets/images/client/06.svg" class="grayscale px-sm-3" alt="client-img">
							</div>
							<!-- Image -->
							<div class="swiper-slide">
								<img src="assets/images/client/07.svg" class="grayscale px-sm-3" alt="client-img">
							</div>
						</div>
					</div>
				</div>
