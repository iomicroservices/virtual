		...
		<div class="row g-4 g-lg-5">
			...
			<div class="col-md-6">
				<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
					...
					<div class="d-flex flex-column ms-4">
						<h5 class="mb-3">{{ feature1 }}</h5>
						<p class="mb-3">{{ description1 }}</p>
						<a class="icon-link icon-link-hover stretched-link mt-auto" :href="button1href">{{ button1 }}<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
					...
					<!-- Title -->
					<div class="d-flex flex-column ms-4">
						<h5 class="mb-3">{{ feature2 }}</h5>
						<p class="mb-3">{{ description2 }}</p>
						<a class="icon-link icon-link-hover stretched-link mt-auto" :href="button2href">{{ button2 }}<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
					...
					<!-- Title -->
					<div class="d-flex flex-column ms-4">
						<h5 class="mb-3">{{ feature3 }}</h5>
						<p class="mb-3">{{ description3 }}</p>
						<a class="icon-link icon-link-hover stretched-link mt-auto" :href="button3href">{{ button3 }}<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
					...
					<!-- Title -->
					<div class="d-flex flex-column ms-4">
						<h5 class="mb-3">{{ feature4 }}</h5>
						<p class="mb-3">{{ description4 }}</p>
						<a class="icon-link icon-link-hover stretched-link mt-auto" :href="button4href">{{ button4 }}<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
					...
					<!-- Title -->
					<div class="d-flex flex-column ms-4">
						<h5 class="mb-3">{{ feature5 }}</h5>
						<p class="mb-3">{{ description5 }}</p>
						<a class="icon-link icon-link-hover stretched-link mt-auto" :href="button5href">{{ button5 }}<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
					...
					<!-- Title -->
					<div class="d-flex flex-column ms-4">
						<h5 class="mb-3">{{ feature6 }}</h5>
						<p class="mb-3">{{ description6 }}</p>
						<a class="icon-link icon-link-hover stretched-link mt-auto" :href="button6href">{{ button6 }}<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
					...
					<!-- Title -->
					<div class="d-flex flex-column ms-4">
						<h5 class="mb-3">{{ feature7 }}</h5>
						<p class="mb-3">{{ description7 }}</p>
						<a class="icon-link icon-link-hover stretched-link mt-auto" :href="button7href">{{ button7 }}<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
					...
					<!-- Title -->
					<div class="d-flex flex-column ms-4">
						<h5 class="mb-3">{{ feature8 }}</h5>
						<p class="mb-3">{{ description8 }}</p>
						<a class="icon-link icon-link-hover stretched-link mt-auto" :href="button8href">{{ button8 }}<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
					...
					<!-- Title -->
					<div class="d-flex flex-column ms-4">
						<h5 class="mb-3">{{ feature9 }}</h5>
						<p class="mb-3">{{ description9 }}</p>
						<a class="icon-link icon-link-hover stretched-link mt-auto" :href="button9href">{{ button9 }}<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
