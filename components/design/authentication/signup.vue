			...
			<div class="col-sm-10 col-lg-5 d-flex m-auto vh-100">
				<div class="row w-100 m-auto">
					<div class="col-lg-10 my-5 m-auto">
						...
						<h2 class="mb-0">Create your
							<span class="position-relative">account
								<!-- SVG START -->
						...
						<p class="mb-0">Let's get started with your 30 days free trial</p>
						...
						<form>
							...
							<div class="mb-4">
								<div class="form-check">
									...
									<label class="form-check-label" for="checkbox-1">I agree to all Terms & conditions and the privacy policy.</label>
								</div>
							</div>
							<!-- Button -->
							<div class="align-items-center mt-0">
								<div class="d-grid">
									<button class="btn btn-dark mb-0" type="button">Create an account</button>
								</div>
							</div>
						</form>
						<!-- Form END -->
