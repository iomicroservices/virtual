	...
	<div class="container position-relative pt-4 pt-lg-0">
		<div class="row align-items-center">
			...
			<div class="col-md-7 col-xl-6 mb-6 mb-md-0">
				...
				<p class="mb-7">Gain valuable insights into your digital campaigns with our comprehensive data analytics and reporting feature.</p>
				...
				<div class="swiper" data-swiper-options='{
					...
					<div class="swiper-wrapper align-items-center">
						...
						<div class="swiper-slide">
							<img src="assets/images/client/05.svg" class="pe-sm-3" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="assets/images/client/04.svg" class="pe-sm-3" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="assets/images/client/01.svg" class="pe-sm-3" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="assets/images/client/02.svg" class="pe-sm-3" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="assets/images/client/03.svg" class="pe-sm-3" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="assets/images/client/06.svg" class="pe-sm-3" alt="client-img">
						</div>
					</div>
				</div>
				<!-- Client-Slider END -->
